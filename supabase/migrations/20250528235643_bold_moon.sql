...
ALTER INDEX IF EXISTS vehicles_pkey RENAME TO vehicle_parking_spot_pkey;
ALTER INDEX IF EXISTS vehicle_history_license_plate_user_id_idx RENAME TO vehicles_license_plate_user_id_idx;
ALTER INDEX IF EXISTS vehicle_history_pkey RENAME TO vehicles_pkey;
